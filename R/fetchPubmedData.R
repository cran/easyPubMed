fetchPubmedData <-
function(pubmedIdList, retstart = 0, retmax = 500) {
  
  myIDlist <- pubmedIdList
  ...
  if ((!is.list(myIDlist)) |
    ...
    stop("There is an issue with the PubMed ID list you supplied. Please, call the function again and supply the result of a <getPubmedIds()> call as argument. Thank you.") 
  } else {
